...
export class RegisterComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
              private _checkEmailService: CheckEmailService,
    ...
    this.registrationForm = fb.group({
      ...
      email: ['', [Validators.required, Validators.pattern(this.emailPattern)],
        [this._checkEmailService.emailValidate()]
      ],
  ...
  registerUser() {
    ...
    this._userService.registerUser({...this.registrationForm.value}).subscribe((response: { message: string }) => {
